defmodule Parenthese.ProjectsTest do
  ...
  describe "projects" do
    ...
    @valid_attrs %{date: ~D[2010-04-17], description: "some description", flickr_id: "some flickr_id", location: "some location", status: "some status", title: "some title", vimeo_ids: [], youtube_ids: []}
    ...
    test "create_project/1 with valid data creates a project" do
      ...
      assert project.date == ~D[2010-04-17]
    ...
    test "update_project/2 with valid data updates the project" do
      ...
      assert project.date == ~D[2011-05-18]
